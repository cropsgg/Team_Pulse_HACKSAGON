...
export const metadata: Metadata = {
  title: 'How It Works - ImpactChain & CharityChain',
  description: 'Learn how our AI-powered blockchain platform enables transparent, accountable funding through smart contracts and DAO governance.',
};
